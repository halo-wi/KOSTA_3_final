...
public class ProductPackageService {
	...
	public PackageVO insertPackage(ProductListVO productList) {
	    ...
	    String filePath = basePath + "/" + productList.getFiles()[0].getOriginalFilename();
	    File dest = new File(filePath);
	    try {
			productList.getFiles()[0].transferTo(dest);
		...
		PackageVO packageVO = PackageVO.builder().
				...
				img(productList.getFiles()[0].getOriginalFilename()).
				build();
